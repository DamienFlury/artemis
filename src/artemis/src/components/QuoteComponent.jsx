...
const quotes = [
  ...
  { quote: 'Those who dare to fail miserably can achieve greatly.', author: 'Unknown' },
  { quote: 'It is hard to fail, but it is worse never to have tried to succeed.', author: 'Unknown' },
